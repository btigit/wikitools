...
package wiki.hadoop.mapred.lib.input;
...
public class ByteMatcher {
  ...
  private long bytes;
  public ByteMatcher(InputStream in, Seekable pos, long lastPos, long currentPos) throws IOException {
    this.in = in;
    this.pos = pos;
    this.bytes = 0;
  ...
  public ByteMatcher(SeekableInputStream is, long start) throws IOException {
    this(is, is, start, start);
  }
